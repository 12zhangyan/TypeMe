...
const DIST_ASSETS = join(ROOT, 'frontend/dist/assets')
...
const bundle = files.map((name) => readFileSync(join(DIST_ASSETS, name), 'utf8')).join('\n')
...
console.log(`查了 ${files.length} 个产物文件（${files.join('、')}）`)
